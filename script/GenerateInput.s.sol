...
// Merkle tree input file generator script, this will be run offchain
// To use:
// Run `forge script script/GenerateInput.s.sol:GenerateInput` to generate the input file
contract GenerateInput is Script {
    uint256 private constant AMOUNT = 25 * 1e18; //amount of tokens
    ...
    function run() public {
        types[0] = "address";
        types[1] = "uint";
        whitelist[0] = "0x6CA6d1e2D5347Bfab1d91e883F1915560e09129D"; //addresses where i want to airdrop
